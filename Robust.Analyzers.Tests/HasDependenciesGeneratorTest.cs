...
public sealed class HasDependenciesGeneratorTest
{
    ...
    public void TestBasic()
    {
        var result = RunGenerator("""
            ...
            public sealed partial class Foobar
            {
                ...
                [Dependency(IoCMode.Optional)]
                public TestB? Bar;

                [Dependency(IoCMode.Differed)]
                public TestC FooDiff;

                [Dependency(IoCMode.DifferedOptional)]
                public TestD? BarDiff;
            }
            """);
        ...
        ExpectSource(
            ...
            public partial class Foobar : global::Robust.Shared.IoC.IHasDependencies
            {
                ...
                {
                    Foo = dependencies.ResolveInject<global::Robust.Shared.IoC.TestA>(typeof(Foobar));
                    Bar = dependencies.TryResolveInject<global::Robust.Shared.IoC.TestB>(typeof(Foobar));
                }

                [global::Robust.Shared.Analyzers.RobustAutoGenerated]
                void global::Robust.Shared.IoC.IHasDependencies.DifferedInject(global::Robust.Shared.IoC.IDependencyCollection dependencies)
                {
                    Foo = dependencies.ResolveInject<global::Robust.Shared.IoC.TestC>(typeof(Foobar));
                    Bar = dependencies.TryResolveInject<global::Robust.Shared.IoC.TestD>(typeof(Foobar));
                }
            }
    ...
    public void TestInheritGeneric()
    {
        var result = RunGenerator("""
            ...
            {
                [Dependency]
                public TestA _yipp = null!;

                [Dependency(IoCMode.Optional)]
                public TestB? _merp = null!;
            }
            """);
        ...
        ExpectNamedSource(
            ...
            public partial class Foo<T> : global::Robust.Shared.IoC.IHasDependencies
            {
                ...
                void global::Robust.Shared.IoC.IHasDependencies.DifferedInject(global::Robust.Shared.IoC.IDependencyCollection dependencies)
                {
                    DifferedInjectImpl(dependencies);
                }
                ...
                {
                    _x = dependencies.ResolveInject<global::Robust.Shared.IoC.TestA>(typeof(Foo<T>));
                    _y = dependencies.TryResolveInject<global::Robust.Shared.IoC.TestB>(typeof(Foo<T>));
                }
            }
        ...
        ExpectNamedSource(
            ...
            public partial class Bar
            {
                ...
                {
                    _yipp = dependencies.ResolveInject<global::Robust.Shared.IoC.TestA>(typeof(Bar));
                    _merp = dependencies.TryResolveInject<global::Robust.Shared.IoC.TestB>(typeof(Bar));
                    base.InjectImpl(dependencies);
                }

                [global::Robust.Shared.Analyzers.RobustAutoGenerated]
                protected override void DifferedInjectImpl(global::Robust.Shared.IoC.IDependencyCollection dependencies)
                {
                    base.DifferedInjectImpl(dependencies);
                }
            }
    ...
    public void TestGenericInherit()
    {
        ...
        ExpectNamedSource(
            ...
            public partial class Foo : global::Robust.Shared.IoC.IHasDependencies
            {
                ...
                protected virtual void InjectImpl(global::Robust.Shared.IoC.IDependencyCollection dependencies)
                {
                    _x = dependencies.ResolveInject<global::Robust.Shared.IoC.TestA>(typeof(Foo));
                    _y = dependencies.TryResolveInject<global::Robust.Shared.IoC.TestB>(typeof(Foo));
                }
            }
        ...
        ExpectNamedSource(
            ...
            public partial class Bar<T>
            {
                ...
                protected override void InjectImpl(global::Robust.Shared.IoC.IDependencyCollection dependencies)
                {
                    _yipp = dependencies.ResolveInject<global::Robust.Shared.IoC.TestA>(typeof(Bar<T>));
                    _merp = dependencies.TryResolveInject<global::Robust.Shared.IoC.TestB>(typeof(Bar<T>));
                    base.InjectImpl(dependencies);
                }
            }
        ...
        ExpectSource(
            ...
            public partial class Real
            {
                ...
                public partial class Foobar : global::Robust.Shared.IoC.IHasDependencies
                {
                    ...
                    void global::Robust.Shared.IoC.IHasDependencies.Inject(global::Robust.Shared.IoC.IDependencyCollection dependencies)
                    {
                        Foo = dependencies.ResolveInject<global::Robust.Shared.IoC.TestA>(typeof(Real.Foobar));
                        Bar = dependencies.TryResolveInject<global::Robust.Shared.IoC.TestB>(typeof(Real.Foobar));
                    }
                }
            }
